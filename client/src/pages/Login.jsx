      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" aria-describedby={error ? 'login-error' : undefined}>
            <div>
              <label htmlFor="login-email" className="block text-stone-700 text-sm font-medium mb-1.5">Email address</label>
              <input
                id="login-email"
                type="email"
                name="email"
            ...
            <div>
              <label htmlFor="login-password" className="block text-stone-700 text-sm font-medium mb-1.5">Password</label>
